/*:
 **Target：move one doughnut from chocolate A to C**
 ...
 Hint：You can use moveDoughnut(from:A, to:C)
 */
//#-hidden-code
...
public extension GameViewController {
    ...
    @objc public func successPass() {
        ...
        PlaygroundPage.current.assessmentStatus = .pass(message: "Congratulations, you have learned how to use code to move the doughnuts! \n\n[next](@next)")
    }
