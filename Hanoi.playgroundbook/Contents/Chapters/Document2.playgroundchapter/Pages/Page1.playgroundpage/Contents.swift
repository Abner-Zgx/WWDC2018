 ...
 **Target：use the pattern to move an even number of doughnuts**
 ...
 Note：If you have an even number of doughnuts, it is carried out by the following two steps
 
 * Step1 move the smallest doughnut from now to the next bar by the cyclic order of A➔B➔C➔A
...
public extension GameViewController {
    ...
    public func setupHint() {
        ...
        //线索9
        hint8 = createHint(hint: hint9, text: "move the smallest doughnut by the cyclic order of B➔C", alpha: 0.0)
...
public extension GameViewController {
    ...
    @objc public func successPass() {
        PlaygroundPage.current.assessmentStatus = .pass(message: "Congratulations on learning the pattern of even numbers! \n\n[next](@next)")
    }
